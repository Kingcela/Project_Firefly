...
# VGA CLK / VSync
create_generated_clock -divide_by 2 -source [get_ports MAX10_CLK1_50] [get_nets {VGA_|clkdiv}]
create_generated_clock -source [get_nets {VGA_|clkdiv}] [get_nets {VGA_|vs}]
#create_generated_clock -source [get_nets {VGA_|clkdiv}] -name vga_pixel_ext [get_nets {VGA_Clk}]
#create_generated_clock -source [get_nets {VGA_|vs}] -name vga_vs_ext [get_ports {VGA_VS}]



# SDRAM CLK
create_generated_clock -source [get_nets { m_lab61_soc|sdram_ppl|sd1|wire_pll7_clk[1] }] \
...
set_false_path -from [get_ports HEX*] -to *
set_false_path -from * -to [get_ports HEX*]
set_false_path -from [get_ports VGA*] -to *
