...
//	input[1]=val;
//
//	return_code = alt_avalon_spi_command(SPI_0_BASE,0,2,input,0,&rdata,0); //&rdata cant be NULL
//
//	if(return_code < 0)
...
//	}
//
//	return_code = alt_avalon_spi_command(SPI_0_BASE,0,nbytes+1,input,0,&rdata,0);
//
//	if(return_code < 0)
// 		printf("ERROR SPI TX RET = %x \n" , return_code);
//	return (data+nbytes);
...
//	//return val
//
//	wdata = reg; //temp value needed
//
//	return_code = alt_avalon_spi_command(SPI_0_BASE, 0,1,&wdata,2,&rdata,0);
//
//	if(return_code < 0)
// 		printf("ERROR SPI TX RET = %x \n" , return_code);
//	return rdata;
...
//	wdata = reg;
//
//	return_code = alt_avalon_spi_command(SPI_0_BASE,0,1,&(wdata),nbytes+1,data,0);  //��Ҫ��һ��������Ϊread����data����read reg ��ʼ8 clk֮��
//
//	//return_code = alt_avalon_spi_command(SPI_0_BASE,0,0,NULL,nbytes+1,data,0);
//	if(return_code < 0)
// 		printf("ERROR SPI TX RET = %x \n" , return_code);
//	return (data+nbytes);
//}
